...
<<<<<<< HEAD
	en una matriz de tama�o 50 x 50, donde cada entrada representa un bloque de una ciudad ficticia*/
=======
...
<<<<<<< HEAD
	public enum Productos{lACTEOS, CARNES, VEGETALES, FRUTAS, GRANOS} // Tipos de productos ofrecidos por el almac�n
	public static Pedido pedido; //Pedido perteneciente al cliente en cuesti�n.
=======
...
<<<<<<< HEAD
	public static ArrayList<Picker>pickers = new ArrayList<>();// lista de los Pickers del almac�n
	public static ArrayList<Conductor>conductores = new ArrayList<>();// lista de los conductores del almac�n 
=======
...
<<<<<<< HEAD
		frutas.add(new Producto("Pi�a", 2000, 50));
=======
